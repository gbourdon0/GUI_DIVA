...
def read_data(byte_list, binary_file):
    ...
    return header,{'ZoneMarkers':zone_markers,
            'Zones':zones_list}

if __name__ =="__main__":

    f = open("../../plots/anim001.plt","rb")
    bytes_list = f.read()
    #print(read_data(bytes_list,"anim000.plt"))
    data = read_data(bytes_list,f)
    #print(data["Zones"][0]["Temperature"])
    print(data[1])
    f.close()
